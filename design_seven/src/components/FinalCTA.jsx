    ...
    <section className="section" id="contact" style={{ borderBottom: '1px solid var(--border)' }}>
      <div className="container final-cta">
        <div className="final-cta-container animate-fade-up animated">
          ...
          <p>NEX AV Designs Private Limited — driven by a passion for absolute technology. Architectural Acoustics, sound system design, and prompt post-project service.</p>
